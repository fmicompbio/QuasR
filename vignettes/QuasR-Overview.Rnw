...
\date{Modified: August 9 2013. Compiled: \today}
...
In order not to miss miRNAs that have a couple of extra bases, we therefore extend the genomic regions of the mature miRNAs, by adding three bases upstream of the 5'-end, and six bases downstream of the 3'-end:
