...
`r Biocpkg("Rhisat2")` package was available, `qAlign(... splicedAlignment=TRUE)`
aligned reads using SpliceMap, which is still possible for legacy reasons, but not
recommended. Spliced paired-end alignments are also supported; the `splicedAlignment`
